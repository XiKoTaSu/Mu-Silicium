...
class CommonPlatform ():
    PackagesSupported = ("a37Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a37', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "a37", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "a37Pkg/a37.dsc", "Platform Hardcoded")
